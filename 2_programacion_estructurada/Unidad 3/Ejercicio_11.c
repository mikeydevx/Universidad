...
// Ejercicio 1
int sumar_ej1(int n1, int n2) { return n1 + n2; }
int restar_ej1(int n1, int n2) { return n1 - n2; }
int multiplicar_ej1(int n1, int n2) { return n1 * n2; }
float dividir_ej1(int n1, int n2) { return (float)n1 / n2; }
...
int main()
{
    ...
    do
    {
        ...
        printf("2. Ejercicio 2 (Menor de 2 numeros)\n");
        printf("3. Ejercicio 3 (Mayor y menor de 2 numeros)\n");
        printf("4. Ejercicio 4 (Celsius a Fahrenheit/Kelvin)\n");
        printf("5. Ejercicio 5 (Centimetros a Pulgadas/Pies)\n");
        printf("6. Ejercicio 6 (Costo e IVA)\n");
        printf("7. Ejercicio 7 (Diferencia de edades)\n");
        printf("8. Ejercicio 8 (Dias de la semana)\n");
        printf("9. Ejercicio 9 (Suma de digitos)\n");
        printf("10. Ejercicio 10 (Numero primo)\n");
        printf("0. Salir\n");
